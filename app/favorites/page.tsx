        ...
        <div className="relative mx-auto max-w-7xl px-4 py-14 sm:px-6 sm:py-20">
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <p className="mt-4 max-w-2xl text-sm leading-6 text-slate-600 sm:text-base">
              Keep your favorite anime in one place and
              quickly return to the stories you love.
            </p>
        ...
        {!loaded ? (
          ...
          <div className="mx-auto max-w-xl rounded-3xl border border-slate-200 bg-white px-6 py-16 text-center shadow-sm sm:px-10">
            ...
            <p className="mx-auto mt-3 max-w-md text-sm leading-6 text-slate-500 sm:text-base">
              Start exploring anime and add your favorites
              here. Your saved anime will appear on this page.
            </p>
